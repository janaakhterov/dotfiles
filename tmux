...
# Java
tmux new-session -s java -d -c ~/ghq/github.com/hashgraph/sdk/java/v1 -n 'v1'
tmux send-keys -t java:v1 'git fetch' C-m
tmux split-window -h -t java:v1 -l '85%' -c ~/ghq/github.com/hashgraph/sdk/java/v1 'nvim' 
tmux new-window -c ~/ghq/github.com/hashgraph/sdk/java/v2 -n 'v2'
tmux send-keys -t java:v2 'git fetch' C-m
tmux split-window -t java:v2 -h -l '85%' -c ~/ghq/github.com/hashgraph/sdk/java/v2 'nvim' 

# Javascript
tmux new-session -s javascript -d -c ~/ghq/github.com/hashgraph/sdk/javascript/v1 -n 'v1'
tmux send-keys -t javascript:v1 'git fetch' C-m
tmux split-window -h -t javascript:v1 -l '85%' -c ~/ghq/github.com/hashgraph/sdk/javascript/v1 'nvim' 
tmux new-window -c ~/ghq/github.com/hashgraph/sdk/javascript/v2 -n 'v2'
tmux send-keys -t javascript:v2 'git fetch' C-m
tmux split-window -t javascript:v2 -h -l '85%' -c ~/ghq/github.com/hashgraph/sdk/javascript/v2 'nvim' 

# Go
tmux new-session -s go -d -c ~/ghq/github.com/hashgraph/sdk/go/v2 -n 'v2'
tmux send-keys -t go:v2 'git fetch' C-m
tmux split-window -h -t go:v2 -l '85%' -c ~/ghq/github.com/hashgraph/sdk/go/v2 'nvim' 
...
# Protobufs
tmux new-session -s proto -d -c ~/.ghq/github.com/hashgraph/protobufs/hedera -n 'hedera'
tmux send-keys -t 'proto:hedera' 'git fetch' C-m
tmux split-window -h -t 'protobufs:hedera' -l '85%' -c ~/.ghq/github.com/hashgraph/protobufs/hedera 'nvim' 
...
# Services
tmux new-session -s services -d -c ~/.ghq/github.com/hashgraph/hedera-services -n 'hedera'
tmux send-keys -t 'services:hedera' 'git fetch' C-m
tmux split-window -h -t 'services:hedera' -l '85%' -c ~/.ghq/github.com/hashgraph/hedera-services 'nvim' 
